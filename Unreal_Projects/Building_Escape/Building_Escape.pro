...
unrealRootPath=/home/george/Game_Development/Engines/UnrealEngine
Building_EscapeRootPath=/home/george/Game_Development/Unreal_Projects/Building_Escape

gameProjectFile=/home/george/Game_Development/Unreal_Projects/Building_Escape/Building_Escape.uproject
...
include(Building_EscapeSource.pri)
include(Building_EscapeHeader.pri)
include(Building_EscapeConfig.pri)
include(Building_EscapeIncludes.pri)
include(Building_EscapeDefines.pri)
...
Building_Escape-Linux-Debug.commands = $$build Building_Escape Linux Debug  -project="\"$$gameProjectFile\"" $$args
Building_Escape-Linux-DebugGame.commands = $$build Building_Escape Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Building_Escape-Linux-Shipping.commands = $$build Building_Escape Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Building_Escape-Linux-Test.commands = $$build Building_Escape Linux Test  -project="\"$$gameProjectFile\"" $$args
Building_Escape.commands = $$build Building_Escape Linux Development  -project="\"$$gameProjectFile\"" $$args

Building_EscapeEditor-Linux-Debug.commands = $$build Building_EscapeEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
Building_EscapeEditor-Linux-DebugGame.commands = $$build Building_EscapeEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Building_EscapeEditor-Linux-Shipping.commands = $$build Building_EscapeEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Building_EscapeEditor-Linux-Test.commands = $$build Building_EscapeEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
Building_EscapeEditor.commands = $$build Building_EscapeEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	Building_Escape-Linux-Debug \
	Building_Escape-Linux-DebugGame \
	Building_Escape-Linux-Shipping \
	Building_Escape-Linux-Test \
	Building_Escape \
	Building_EscapeEditor-Linux-Debug \
	Building_EscapeEditor-Linux-DebugGame \
	Building_EscapeEditor-Linux-Shipping \
	Building_EscapeEditor-Linux-Test \
	Building_EscapeEditor \
